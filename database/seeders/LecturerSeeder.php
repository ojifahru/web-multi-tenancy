...
class LecturerSeeder extends Seeder
{
    ...
    public function run(?int $studyProgramId = null): void
    {
        ...
        if ($studyProgramIds->isEmpty()) {
            if (isset($this->command)) {
                $this->command->warn('Tidak ada program studi. Buat prodi terlebih dahulu sebelum menjalankan LecturerSeeder.');
            }
    ...
    private function resolveStudyProgramIds(?int $studyProgramId = null)
    {
        ...
        $selectedStudyProgramId = $this->command->ask('Masukkan ID prodi untuk LecturerSeeder (kosongkan untuk semua prodi)');
